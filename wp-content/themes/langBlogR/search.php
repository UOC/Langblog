<?php get_header(); ?>
    ...
    <div id="main" class="m-all t-2of3 d-5of7 last-col clearfix" role="main">
      ...
      <h1 class="archive-title"><span><?php _e('Search results', 'langblogR'); ?>:</span> <?php echo esc_attr(get_search_query()); ?></h1>
      ...
      <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
              ...
              <?php else : ?>
                  ...
                  <article id="post-not-found" class="hentry clearfix">
                    ...
                    <section class="article-content">
                        <p><?php _e("No contribution found! Try another search.", 'langblogR'); ?></p>
