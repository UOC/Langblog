    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
              ...
              <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
                ...
                <footer class="article-footer">
                  ...
                  <?php comments_popup_link(__('You can post a contribution', 'langblogR'), __('You can post a contribution (1)', 'langblogR'), __('You can post a contribution (%)', 'langblogR'), 'link-comments', __('You can post a contribution', 'langblogR')); ?>

                  <?php edit_post_link( __('Edit this contribution', 'langblogR')); ?>
