...
<div id="navigation"> 
  <div class="alignleft"><?php //previous_post_link(__('Back')) ?>
  		<h2><a href="<?php //bloginfo('url'); ?>" ><?php //_e('Home') ?></a> &gt; <?php //the_category(', ') ?> &gt; <?php //the_title(); ?></h2>
  </div>
  <div class="alignright"><?php //next_post_link(__('Next')) ?><a href="<?php //bloginfo('url'); ?>" ></a></div>
</div>
-->
...
<div class="article" id="post-<?php the_ID(); ?>"> 
  ...
  <div id="metadata">
   ...
   <?php _e('You can post a') ?>&nbsp;&nbsp;<img src="<?php bloginfo('stylesheet_directory');?>/images/v2/iconoComentario.png" width="19" height="16"/>&nbsp;&nbsp;<a href="#respond"><?php _e('contribution') ?></a>
    <?php } elseif (!('open' == $post-> comment_status) && ('open' == $post->ping_status)) {
							// Only Pings are Open ?><?php }?>&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php bloginfo('stylesheet_directory');?>/images/v2/iconoOjo.png" width="16" height="10"/>&nbsp;&nbsp;<?php comments_rss_link(__("See subscription")); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php comments_rss_link2(__("See subscriptionV")); ?>&nbsp;&nbsp;&nbsp;<img src="<?php bloginfo('stylesheet_directory');?>/images/v2/iconoEditar.png" width="16" height="15"/>&nbsp;&nbsp;<?php  edit_post_link(__('Edit this contribution'),'',''); ?>
</div><br/><br/>
</div>
