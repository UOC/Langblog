 ...
 * @subpackage Client
 */
class KalturaEventNotificationDispatchJobData extends KalturaBaseAPI\KalturaJobData
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
abstract class KalturaEventNotificationTemplateBaseFilter extends KalturaBaseAPI\KalturaFilter
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaEventNotificationClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
