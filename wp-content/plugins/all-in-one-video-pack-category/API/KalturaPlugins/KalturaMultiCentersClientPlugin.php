 ...
 * @subpackage Client
 */
class KalturaFileSyncImportJobData extends KalturaBaseAPI\KalturaJobData
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaMultiCentersClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
