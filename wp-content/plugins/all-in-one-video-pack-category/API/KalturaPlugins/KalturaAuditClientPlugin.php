 ...
 * @subpackage Client
 */
abstract class KalturaAuditTrailInfo extends KalturaBaseAPI\KalturaObjectBase
{
 ...
 * @subpackage Client
 */
class KalturaAuditTrail extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaAuditTrailChangeItem extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaAuditTrailListResponse extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
abstract class KalturaAuditTrailBaseFilter extends KalturaBaseAPI\KalturaFilter
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaAuditTrailService extends KalturaBaseAPI\KalturaServiceBase
{
	...
	function listAction(KalturaAuditTrailFilter $filter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
 ...
 * @subpackage Client
 */
class KalturaAuditClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
