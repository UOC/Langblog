 ...
 * @subpackage Client
 */
class KalturaVarPartnerUsageItem extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * Partner ID
	 * 	 
 ...
 * @subpackage Client
 */
class KalturaPartnerUsageListResponse extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaVarConsolePartnerFilter extends KalturaBaseAPI\KalturaPartnerFilter
{
	/**
 ...
 * @subpackage Client
 */
class KalturaVarConsoleService extends KalturaBaseAPI\KalturaServiceBase
{
	...
	function getPartnerUsage(KalturaPartnerFilter $partnerFilter = null, KalturaReportInputFilter $usageFilter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
 ...
 * @subpackage Client
 */
class KalturaVarConsoleClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
