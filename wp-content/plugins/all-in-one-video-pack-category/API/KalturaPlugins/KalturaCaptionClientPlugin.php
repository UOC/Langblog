 ...
 * @subpackage Client
 */
class KalturaCaptionAsset extends KalturaBaseAPI\KalturaAsset
{
	/**
 ...
 * @subpackage Client
 */
class KalturaCaptionAssetListResponse extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaCaptionParams extends KalturaBaseAPI\KalturaAssetParams
{
	/**
 ...
 * @subpackage Client
 */
class KalturaCaptionParamsListResponse extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
abstract class KalturaCaptionAssetBaseFilter extends KalturaBaseAPI\KalturaAssetFilter
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
abstract class KalturaCaptionParamsBaseFilter extends KalturaBaseAPI\KalturaAssetParamsFilter
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaCaptionAssetService extends KalturaBaseAPI\KalturaServiceBase
{
	...
	function listAction(KalturaAssetFilter $filter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
 ...
 * @subpackage Client
 */
class KalturaCaptionParamsService extends KalturaBaseAPI\KalturaServiceBase
{
	function __construct(KalturaBaseAPI\KalturaClient $client = null)
	{
		parent::__construct($client);
	...
	function listAction(KalturaCaptionParamsFilter $filter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
			$this->client->addParam($kparams, "filter", $filter->toParams());
 ...
 * @subpackage Client
 */
class KalturaCaptionClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
