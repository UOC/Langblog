 ...
 * @subpackage Client
 */
class KalturaBulkUploadCsvJobData extends KalturaBaseAPI\KalturaBulkUploadJobData
{
	/**
 ...
 * @subpackage Client
 */
class KalturaBulkUploadCsvClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
