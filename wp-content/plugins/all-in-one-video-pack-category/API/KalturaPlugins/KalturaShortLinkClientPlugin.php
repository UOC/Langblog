 ...
 * @subpackage Client
 */
class KalturaShortLink extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaShortLinkListResponse extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
abstract class KalturaShortLinkBaseFilter extends KalturaBaseAPI\KalturaFilter
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaShortLinkService extends KalturaBaseAPI\KalturaServiceBase
{
	...
	function listAction(KalturaShortLinkFilter $filter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
 ...
 * @subpackage Client
 */
class KalturaShortLinkClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
