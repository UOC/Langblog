 ...
 * @subpackage Client
 */
abstract class KalturaFileSyncBaseFilter extends KalturaBaseAPI\KalturaFilter
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaFileSyncClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
