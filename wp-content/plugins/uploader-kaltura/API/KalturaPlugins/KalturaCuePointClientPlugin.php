 ...
 * @subpackage Client
 */
abstract class KalturaCuePoint extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaCuePointListResponse extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
abstract class KalturaCuePointBaseFilter extends KalturaBaseAPI\KalturaFilter
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaCuePointService extends KalturaBaseAPI\KalturaServiceBase
{
	...
	function serveBulk(KalturaCuePointFilter $filter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
	...
	function listAction(KalturaCuePointFilter $filter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
			$this->client->addParam($kparams, "filter", $filter->toParams());
 ...
 * @subpackage Client
 */
class KalturaCuePointClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
