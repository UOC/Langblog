 ...
 * @subpackage Client
 */
class KalturaSystemPartnerLimit extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaSystemPartnerConfiguration extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaSystemPartnerPackage extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaSystemPartnerUsageItem extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * Partner ID
	 * 	 
 ...
 * @subpackage Client
 */
class KalturaSystemPartnerUsageListResponse extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaSystemPartnerUsageFilter extends KalturaBaseAPI\KalturaFilter
{
	/**
	 * Date range from
	 * 	 
 ...
 * @subpackage Client
 */
class KalturaSystemPartnerService extends KalturaBaseAPI\KalturaServiceBase
{
	...
	function getUsage(KalturaPartnerFilter $partnerFilter = null, KalturaSystemPartnerUsageFilter $usageFilter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
	...
	function listAction(KalturaPartnerFilter $filter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
	...
	function listUserLoginData(KalturaUserLoginDataFilter $filter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
			$this->client->addParam($kparams, "filter", $filter->toParams());
 ...
 * @subpackage Client
 */
class KalturaSystemPartnerClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
