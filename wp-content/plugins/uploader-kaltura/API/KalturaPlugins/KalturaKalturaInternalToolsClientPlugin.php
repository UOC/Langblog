 ...
 * @subpackage Client
 */
class KalturaInternalToolsSession extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaKalturaInternalToolsSystemHelperService extends KalturaBaseAPI\KalturaServiceBase
{
 ...
 * @subpackage Client
 */
class KalturaKalturaInternalToolsClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
