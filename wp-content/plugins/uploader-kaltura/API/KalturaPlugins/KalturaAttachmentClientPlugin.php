 ...
 * @subpackage Client
 */
class KalturaAttachmentAsset extends KalturaBaseAPI\KalturaAsset
{
	/**
 ...
 * @subpackage Client
 */
class KalturaAttachmentAssetListResponse extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
abstract class KalturaAttachmentAssetBaseFilter extends KalturaBaseAPI\KalturaAssetFilter
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaAttachmentAssetService extends KalturaBaseAPI\KalturaServiceBase
{
 ...
 * @subpackage Client
 */
class KalturaAttachmentClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
