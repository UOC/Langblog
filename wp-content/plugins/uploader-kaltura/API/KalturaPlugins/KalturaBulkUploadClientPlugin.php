 ...
 * @subpackage Client
 */
class KalturaBulkService extends KalturaBaseAPI\KalturaServiceBase
{
	...
	function listAction(KalturaBulkUploadFilter $bulkUploadFilter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
 ...
 * @subpackage Client
 */
class KalturaBulkUploadClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
