 ...
 * @subpackage Client
 */
class KalturaVirusScanProfile extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaVirusScanProfileListResponse extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaParseCaptionAssetJobData extends KalturaBaseAPI\KalturaJobData
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaVirusScanJobData extends KalturaBaseAPI\KalturaJobData
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
abstract class KalturaVirusScanProfileBaseFilter extends KalturaBaseAPI\KalturaFilter
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaVirusScanProfileService extends KalturaBaseAPI\KalturaServiceBase
{
	...
	function listAction(KalturaVirusScanProfileFilter $filter = null, KalturaBaseAPI\KalturaFilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
 ...
 * @subpackage Client
 */
class KalturaVirusScanClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
