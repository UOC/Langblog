 ...
 * @subpackage Client
 */
class KalturaCaptionAssetItem extends KalturaBaseAPI\KalturaObjectBase
{
	/**
 ...
 * @subpackage Client
 */
class KalturaCaptionAssetItemListResponse extends KalturaBaseAPI\KalturaObjectBase
{
	/**
	 * 
	 *
 ...
 * @subpackage Client
 */
class KalturaCaptionAssetItemService extends KalturaBaseAPI\KalturaServiceBase
{
	...
	function search(KalturaBaseEntryFilter $entryFilter = null, KalturaCaptionAssetItemFilter $captionAssetItemFilter = null, KalturaBaseAPI\KalturaFilterPager $captionAssetItemPager = null)
	{
		$kparams = array();
		if ($entryFilter !== null)
 ...
 * @subpackage Client
 */
class KalturaCaptionSearchClientPlugin extends KalturaBaseAPI\KalturaClientPlugin
{
	/**
